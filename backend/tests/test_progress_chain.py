...
def mock_export(monkeypatch):
    ...
    def fake_export(title, markdown, output_dir=None, slug=None, data_tables=None, geo_map=None):
...
def test_error_phase_classified_to_six_steps(client, subbed, monkeypatch):
    ...
    def boom(title, markdown, output_dir=None, slug=None, data_tables=None, geo_map=None):  # noqa: ANN001
