...
class ReportGenerator:
    ...
    def build_research_ledger(self, markdown: str, input_text: str = ""):
        ...
        system = (
            ...
            "node 可选字段 region_code：主体属地明确时填 GB/T 2260 六位省级或市级码"
            "（如 440000 广东省、441300 惠州市）；属地不明确、或主体是全国性与跨国的，"
            "一律省略该字段，不要猜——系统会用该主体证据来源的地域去补，填错会误导地理布局。"
            "node 可选字段 behavior：一到两句话概括该主体在此事件中的关键行为与行为逻辑"
            "（做了什么、为什么这么做、追求什么），只能写来源可支撑的内容，禁止心理侧写与阴谋论式归因；"
            "来源撑不起行为逻辑时省略该字段。"
